<%-- 
    Document   : Organisereg
    Created on : Jun 15, 2012, 9:20:19 PM
    Author     : Mandeep
--%>
...
<html>
    ...
    <body>
        <form action="eighth.do">
         <table width="100%" border="0">
               
        <center>
  <tr>
    <td width="321" height="14"></td>
    <td width="59"></td>
    <td width="47"></td>
    <td width="147"></td>
    <td width="399"></td>
  ...
  <tr>
    <td height="19"></td>
    <td valign="top">Organisation's Name </td>
    <td>&nbsp;</td>
    <td valign="top"><label>
  ...
  <tr>
    <td height="19">&nbsp;</td>
    <td valign="top">No. of vacancies </td>
    <td></td>
    <td valign="top"><label>
  ...
  <tr>
    <td height="19"></td>
    <td valign="top">Working Experience </td>
    <td></td>
    <td valign="top"><label>
