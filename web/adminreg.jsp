...
<html>
  ...
  <tr>
    <td height="22"></td>
    <td colspan="5" valign="top">To see the table of all normal registrations type n in following space... </td>
    <td></td>
  </tr>
  <tr>
    <td height="13"></td>
  ...
  <tr>
    <td height="22"></td>
    <td colspan="5" valign="top">To see all table of all organisers type o in following space.... </td>
    <td></td>
  </tr>
  <tr>
    <td height="13"></td>
