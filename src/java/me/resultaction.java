...
public class resultaction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        Statement sm=cs.createStatement();
           ...
           if(t.equals("normal")||t.equals("premium"))
           {
                ResultSet r=sm.executeQuery("select * from organisereg o where o.qualification=(select qualification from premiumreg where username='"+u+"')");
