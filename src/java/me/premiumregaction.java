 ...
 * @author Mandeep
 */
public class premiumregaction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
       ...
       int i=st.executeUpdate("insert into premiumreg values('"+u+"','"+e+"','"+q+"','"+c+"','"+s+"','"+sk+"','"+cn+"','"+w+"')");
       if(i==1)
       {
